    ...
    return (
        <div className='relative pb-32 max-w-screen-2xl mx-auto'>
            ...
            <motion.div
                ...
                className='flex flex-col items-center justify-center max-w-7xl mx-auto bg-white -my-10 inner-curve rounded-lg -z-10'
            >
                <div className='flex flex-col items-center justify-center my-20 gap-4 w-full relative bg-white/50 xl:bg-background/0'>
                    ...
                    <div className='flex flex-col xl:flex-row items-center justify-between gap-10 px-4 w-full max-w-6xl'>
                        <div className='flex flex-col items-start justify-center gap-4 max-w-md z-20'>
                        ...
                        <div
                            className='flex flex-col items-start xl:items-end justify-center gap-4 xl:text-left max-w-md z-20'>
                            <p className='text-green text-lg'>
